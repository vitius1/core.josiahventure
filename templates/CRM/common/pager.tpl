...
{if $pager and $pager->_response}
    {if $pager->_response.numPages > 1}
        <div class="crm-pager" style="display: flex; justify-content: center; margin-top: 15px;">
    ...
    {if $location eq 'bottom' and $pager->_totalItems > 25}
     ...
     <span class="float-right">
       <label style="font-weight: normal;" for="{$form.formClass}-rows-per-page-select">{ts}Rows per page:{/ts}</label> &nbsp;
